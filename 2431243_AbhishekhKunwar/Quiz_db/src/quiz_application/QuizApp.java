...
public class QuizApp extends JPanel {
    ...
    public QuizApp(User user, String level) {
        ...
        questionCard.setBackground(StyleConstants.PRIMARY_COLOR);
        ...
        questionCounterLabel.setFont(StyleConstants.BODY_FONT);
        questionCounterLabel.setForeground(StyleConstants.ACCENT_COLOR);

        questionLabel = new JLabel("<html><div style='text-align: center; width: 700px;'>"
                + questions.get(currentQuestionIndex).getQuestion() + "</div></html>", JLabel.CENTER);
        questionLabel.setFont(StyleConstants.TITLE_FONT);
        questionLabel.setForeground(Color.WHITE);

        timerLabel = new JLabel("30", JLabel.RIGHT);
        timerLabel.setFont(new Font("Segoe UI", Font.BOLD, 36));
        timerLabel.setForeground(StyleConstants.ACCENT_COLOR);
        ...
        submitButton = new JButton("Finish Quiz");
        StyleConstants.styleButton(submitButton);
        submitButton.setBackground(StyleConstants.SUCCESS_COLOR);
        submitButton.setVisible(false);

        exitButton = new JButton("Quit Game");
        StyleConstants.styleSecondaryButton(exitButton);
        exitButton.setForeground(StyleConstants.DANGER_COLOR);
    ...
    private JRadioButton createOptionRadioButton(String text, String prefix) {
        JRadioButton rb = new JRadioButton("<html><b>" + prefix + ":</b> " + text + "</html>");
        rb.setFont(StyleConstants.SUBTITLE_FONT);
        rb.setForeground(StyleConstants.TEXT_PRIMARY);
        rb.setBackground(StyleConstants.CARD_BACKGROUND);
    ...
    private void updateQuestion() {
        Question q = questions.get(currentQuestionIndex);
        questionLabel
                .setText("<html><div style='text-align: center; width: 700px;'>" + q.getQuestion() + "</div></html>");
        questionCounterLabel.setText("Question " + (currentQuestionIndex + 1) + " of " + questions.size());

        optionA.setText("<html><b>A:</b> " + q.getOptionA() + "</html>");
        optionB.setText("<html><b>B:</b> " + q.getOptionB() + "</html>");
        optionC.setText("<html><b>C:</b> " + q.getOptionC() + "</html>");
        optionD.setText("<html><b>D:</b> " + q.getOptionD() + "</html>");
